...
const apps: AppItem[] = [
  ...
  { name: 'AI LifeOS', emoji: '🧠', url: 'https://polite-grass-080bb870f.7.azurestaticapps.net', description: '个人知识操作系统 / Second Brain', domain: 'ai-lifeos', badge: 'ai-lifeos' },
  ...
  { name: '我的简历', emoji: '📄', url: 'https://github.com/szylover/resume/raw/master/resume.pdf', description: '个人简历 / Resume', domain: 'resume', badge: 'resume' },
];
